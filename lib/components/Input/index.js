...
var Input = function (_Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var className = (0, _classNames2.default)('c-Input', 'c-Input--' + size, bold && 'c-Input--bold', disabled && 'is-disabled', error && 'is-error', multiline && 'c-Input--multiline', readOnly && 'is-readonly', resizable && 'c-Input--resizable', seamless && 'c-Input--seamless', success && 'is-success', value && 'has-value', warning && 'is-warning', this.props.className);
