...
var propTypes = {
  ...
  options: _propTypes2.default.oneOfType([groupType, optionType, optionsType, _propTypes2.default.string]),
  ...
  _createClass(Select, [{
    ...
    value: function render () {
      ...
      var _props = this.props,
        ...
        value = _props.value,
        rest = _objectWithoutProperties(_props, ['className', 'disabled', 'error', 'onChange', 'options', 'placeholder', 'prefix', 'readOnly', 'seamless', 'size', 'success', 'warning', 'value'])

      var hasPlaceholder = this.hasPlaceholder()

      var selectClassName = (0, _classNames2.default)('c-Select', disabled && 'is-disabled', error && 'is-error', hasPlaceholder && 'has-placeholder', readOnly && 'is-readonly', seamless && 'is-seamless', success && 'is-success', warning && 'is-warning', className)
      ...
      var optionsMarkup = options.map(renderOptions)
