...
describe('Label', function () {
  ...
  test('Sets ID on the select element', function () {
    var id = 'channel';
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { label: 'Channel', id: id }));
    var label = wrapper.find('Label');
    var select = wrapper.find('select');
...
describe('States', function () {
  ...
  describe('Error', function () {
    ...
    test('Adds error helper text if error prop is a string', function () {
      ...
      var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { state: 'error', helpText: message }));
      var o = wrapper.find('.c-InputHelpText');
  ...
  describe('Success', function () {
    ...
    test('Adds success helper text if success prop is a string', function () {
      var message = 'Cannonballlll';
      var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { state: 'success', helpText: message }));
      var o = wrapper.find('.c-InputHelpText');
  ...
  describe('Warning', function () {
    ...
    test('Adds warning helper text if warning prop is a string', function () {
      var message = 'Cannonballlll';
      var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { state: 'warning', helpText: message }));
      var o = wrapper.find('.c-InputHelpText');
