...
var Text = function Text(props) {
  ...
  var className = (0, _classNames2.default)('c-Text', disableSelect && 'is-disable-select', error && 'is-error', faint && 'c-Text--faint', muted && 'c-Text--muted', size && 'c-Text--' + size, subtle && 'c-Text--subtle', success && 'is-success', truncate && 'c-Text--truncate', warning && 'is-warning', props.className);
