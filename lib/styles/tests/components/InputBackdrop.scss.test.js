...
describe('States', function () {
  test('Applies error styles if defined', function () {
    var markup = (0, _enzyme.mount)(_react2.default.createElement(_Input2.default, { error: true })).html();
    styles.html(markup);
  ...
  test('Applies success styles if defined', function () {
    var markup = (0, _enzyme.mount)(_react2.default.createElement(_Input2.default, { success: true })).html();
    styles.html(markup);
  ...
  test('Applies warning styles if defined', function () {
    var markup = (0, _enzyme.mount)(_react2.default.createElement(_Input2.default, { warning: true })).html();
    styles.html(markup);
