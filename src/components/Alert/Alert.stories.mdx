...
<Meta
  ...
  parameters={{
      design: {
        type: 'figma',
        url: 'https://www.figma.com/file/Wp9mDxTvWicSTWtezj2ImkMP/HSDS-Product?node-id=2582%3A11098'
      }
    }}
/>
...
<Preview>
  <Story name="action on the right">
    <div>
      <Alert actionRight={<Button size="sm" kind="secondary">Action!</Button>} icon>
