  ...
  .add('scrollable', () => (
    <Card seamless flex style={{ height: '100vh' }}>
      ...
      <Card.Block bgMuted scrollable flex>
        <p>
          On Christmas Eve in 1973, an infant boy stows away in Santa Claus'
          sack. When discovered back at the North Pole, he is adopted by Papa
          Elf. Papa Elf names his son Buddy.
        </p>

        <p>
          Buddy grows up at the North Pole believing he is an elf, but due to
          his human size he is unable to perform elf tasks. When Buddy
          accidentally learns that he is human, Papa Elf explains that he was
          born to Walter Hobbs and Susan Wells, and was given up for adoption
          without Walter knowing. Susan died and Walter works at a children's
          book publisher in New York City at the Empire State Building. Santa
          notes that Walter is on the naughty list due to his greed and
          selfishness, but suggests Buddy could help redeem him, and so Buddy
          travels alone to New York.
        </p>
        ...
        <p>
          ...
          arrive the next day, Buddy stays behind and spends the night
          decorating Santa Land, and buys a nightie for Walter.
        </p>
        ...
        <p>
          ...
          trouble after publishing a failed children's book, and organizes a
          book pitch for Christmas Eve, for which Walter and his associates
          Eugene and Morris arrange a meeting with best-selling children's
          author Miles Finch to hire him.
        </p>
