...
<Meta
  ...
  parameters={{
      design: {
        type: 'figma',
        url: 'https://www.figma.com/file/Wp9mDxTvWicSTWtezj2ImkMP/HSDS-Product?node-id=2582%3A10368'
      }
    }}
/>
...
<Preview>
  <Story name="Floating">
    <Card floating hover>Hello, this is a floating hoverable card</Card>
  </Story>
</Preview>
