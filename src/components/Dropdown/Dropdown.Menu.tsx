...
class Menu extends React.PureComponent<DropdownMenuProps, DropdownMenuState> {
  static defaultProps = {
          ...
          <Animate sequence="fade down" in={isOpen} duration={160} timeout={80}>
            <Card seamless floating>
              <div
                ...
                style={{ height: this.height != null ? this.height : '' }}
              >
                <Scrollable
                  scrollableRef={node => {
