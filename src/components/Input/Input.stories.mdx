...
<Meta
  ...
  parameters={{
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/Wp9mDxTvWicSTWtezj2ImkMP/HSDS-Product?node-id=2582%3A9401'
    }
  }}
/>
...
<Preview>
  <Story name="Prefix/Suffix">
    <Input value="1230.00" inlinePrefix={text('inlinePrefix', '$')} inlineSuffix={text('inlineSuffix', '.00')} />
  </Story>
</Preview>
