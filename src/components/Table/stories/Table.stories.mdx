...
If you need more control over the animation, pass an object to `animateRows` with any valid prop for [CSSTransition](https://reactcommunity.org/react-transition-group/css-transition).
